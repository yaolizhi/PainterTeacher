...
+ (void)showError:(NSString *)error toView:(UIView *)view
{
    ...
    hud.contentColor = [UIColor whiteColor];
    hud.label.numberOfLines = 0;
    hud.customView = [[UIImageView alloc]initWithImage:imageName(@"tipError")];
    hud.button.hidden = YES;
...
+ (void)showSuccess:(NSString *)success toView:(UIView *)view
{
    ...
    hud.contentColor = [UIColor whiteColor];
    hud.label.numberOfLines = 0;
    hud.customView = [[UIImageView alloc]initWithImage:imageName(@"tipSucceed")];
    hud.button.hidden = YES;
...
{
    [self showSuccess:success toView:AppWindow];
}
...
+ (void)showError:(id)error
{
    ...
    if (Error.length != 0)
    {
        [self showError:Error toView:AppWindow];
    }
}
...
+ (instancetype)showHUDAddedTo:(UIView *)view animated:(BOOL)animated
{
    ...
    hud.bezelView.style = MBProgressHUDBackgroundStyleSolidColor;
    hud.bezelView.color = [UIColor blackColor];
    UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, ScaleW(45), ScaleW(45))];
    ...
    for (size_t i=0;i < frameCount; i++)
    {
        ...
        imageName = [self scaleToSize:imageName size:CGSizeMake(ScaleW(45), ScaleW(45))];
