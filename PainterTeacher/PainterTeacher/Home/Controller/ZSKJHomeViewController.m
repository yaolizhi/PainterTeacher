...
-(ZSKJHomeCollectionView *)homeCollectionView
{
    ...
    {
        _homeCollectionView = [[ZSKJHomeCollectionView alloc]initWithFrame:CGRectMake(0, self.navbarHeight, ScreenWidth, ScreenHeight-(self.navbarHeight+self.tabbarHeight))];
    }
